...
const byte StepperDriver::Default_Kval_Acceleration = 100;
const byte StepperDriver::Default_Kval_Deceleration = 100;
const byte StepperDriver::Default_Kval_Run = 100;
